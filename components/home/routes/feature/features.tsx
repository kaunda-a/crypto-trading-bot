...
const Features: React.FC = () => {
  ...
  return (
    <section className="relative min-h-screen pt-20 flex items-center justify-center overflow-hidden bg-gradient-to-br from-theme-100 to-theme-300 dark:from-theme-700 dark:to-theme-500">
